...
**ccreds** is an R package for performing Censored-Covariate Regression
with Dual Selection. ccreds allows users to fit penalised
censored-covariate regression models with two separate L1 penalties —
...
containing cross-validation metrics and the full model fit. Use
